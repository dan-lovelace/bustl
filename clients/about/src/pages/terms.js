...
export default function Terms() {
  return (
    <div className="container mx-auto p-5 lg:px-48">
      <Paragraph>Last updated: {getTermsVersion()}</Paragraph>
      <Heading>Terms and Conditions</Heading>
      <Paragraph>
        Please read these Terms and Conditions ("Terms", "Terms and Conditions")
        carefully before using the https://bus.tl website (the "Service")
        operated by LogicNow LLC ("us", "we", or "our").
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        renew under the exact same conditions unless you cancel it or LogicNow
        LLC cancels it. You may cancel your Subscription renewal either through
        the subscription management page or by contacting LogicNow LLC customer
        support team.
      </Paragraph>
      <Paragraph>
        A valid payment method, including credit card, is required to process
        the payment for your Subscription. You shall provide LogicNow LLC with
        ...
        authorize LogicNow LLC to charge all Subscription fees incurred through
        your account to any such payment instruments.
      </Paragraph>
      <Paragraph>
        Should automatic billing fail to occur for any reason, LogicNow LLC will
      ...
      <Paragraph>
        LogicNow LLC may, at its sole discretion, offer a Subscription with a
      ...
      <Paragraph>
        ...
        Trial, you will not be charged by LogicNow LLC until the Free Trial has
      ...
      <Paragraph>
        At any time and without notice, LogicNow LLC reserves the right to (i)
      ...
      <Paragraph>
        LogicNow LLC, in its sole discretion and at any time, may modify the
      ...
      <Paragraph>
        LogicNow LLC will provide you with a reasonable prior notice of any
      ...
      <Paragraph>
        Except when required by law, all purchases and paid Subscription fees
        are non-refundable.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        * By email: <a href="mailto:support@bus.tl">support@bus.tl</a>
      </Paragraph>
      {/* <Paragraph>
      ...
      <Paragraph>
        ...
        to use, modify, reproduce, and distribute such Content on and through
        the Service. You agree that this license includes the right for us to
        make your Content available to other users of the Service whom you have
        shared it with, who may also use your Content subject to these Terms.
      </Paragraph>
      <Paragraph>
        LogicNow LLC has the right but not the obligation to monitor and edit
        all Content provided by users.
      </Paragraph>
      <Paragraph>
        In addition, Content found on or through this Service are the property
        of LogicNow LLC or used with permission. You may not distribute, modify,
      ...
      <Paragraph>
        ...
        to <a href="mailto:support@bus.tl">support@bus.tl</a>, with the subject
      ...
      <Paragraph>
        ...
        property of LogicNow LLC and its licensors. The Service is protected by
      ...
      <Paragraph>
        ...
        are not owned or controlled by LogicNow LLC
      </Paragraph>
      <Paragraph>
        LogicNow LLC has no control over, and assumes no responsibility for the
        content, privacy policies, or practices of any third party web sites or
        services. We do not warrant the offerings of any of these
        entities/individuals or their websites.
      </Paragraph>
      <Paragraph>
        You acknowledge and agree that LogicNow LLC shall not be responsible or
      ...
      <Paragraph>
        You agree to defend, indemnify and hold harmless LogicNow LLC and its
      ...
      <Paragraph>
        In no event shall LogicNow LLC, nor its directors, employees, partners,
      ...
      <Paragraph>
        LogicNow LLC its subsidiaries, affiliates, and its licensors do not
      ...
      <Paragraph>
        ...
        of Colorado, United States, without regard to its conflict of law
        provisions.
      </Paragraph>
      <Paragraph>
